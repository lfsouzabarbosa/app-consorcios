...
class Consulta extends Component {
    ...
    async salvar() {
        ...
        axios.post('https://newcon.ademicon.net.br/n4/AutoAtendimento.Gateway/autoatendimento/v1/login/valores-devolver', {
            ...
            .then(response => {
                ...
                axios({
                    ...
                    url: "https://newcon.ademicon.net.br/n4/AutoAtendimento.Gateway/autoatendimento/v1/cotas"
                })
                    .then(response => {
    ...
    bucarCotaPorID() {
        ...
        axios({
            method: 'get',
            headers: { 'Authorization': 'Bearer ' + token },
            url: "https://newcon.ademicon.net.br/n4/AutoAtendimento.Gateway/autoatendimento/v1/cotas/" + idCota + "/dashboard/consorciado"
        })
            .then(response => {
                //console.log(response.data)
        ...
        axios({
            method: 'get',
            headers: { 'Authorization': 'Bearer ' + token },
            url: "https://newcon.ademicon.net.br/n4/AutoAtendimento.Gateway/autoatendimento/v1/cotas/" + idCota + "/dados-cadastrais/enderecos/0/CO"
        })
            .then(response => {
                //console.log(response.data)
                const resposta = response.data
        ...
        axios({
            method: 'get',
            headers: { 'Authorization': 'Bearer ' + token },
            url: "https://newcon.ademicon.net.br/n4/AutoAtendimento.Gateway/autoatendimento/v1/cotas/" + idCota + "/dados-cadastrais/telefones/0/CO"
        })
            .then(response => {
                //console.log(response.data)
                const resposta = response.data
    ...
    imprimirExtrato() {
        ...
        axios({
            method: 'get',
            headers: { 'Authorization': 'Bearer ' + token },
            url: "https://newcon.ademicon.net.br/n4/AutoAtendimento.Gateway/autoatendimento/v1/cotas/" + idCota + "/extrato/imprimir"
        })
            .then(response => {
                //console.log(response.data)
                const resposta = response.data
                ...
                axios({
                    ...
                    url: "https://newcon.ademicon.net.br/n4/AutoAtendimento.Gateway/autoatendimento/v1/relatorios/" + resposta
                })
                    .then((response) => {
                ...
                <Box display={["block", "flex"]} flexDirection="row" justifyContent="space-between" margin="2%">
                    <Box flex flexDirection="row" variant="white">
                        <Table>
                            <TableBody>
                                <TableCell>
                                    <img src={"https://ademipr.com.br/wp-content/uploads/2021/08/associados_logo_ademicon-scaled.jpg"} width={170} height={100} alt="BigCo Inc. logo" />
                                </TableCell>
                                <TableCell>
                                ...
                                <TableCell>
                                    ...
                                    <Input id="dataNascimentoFundacao" type="date" showMaskOnFocus={true}
                                        onChange={(e) => {
                                            let valorDigitado = e.target.value;
